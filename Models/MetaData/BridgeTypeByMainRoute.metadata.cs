...
{
    [MetadataType(typeof(BridgeTypeByMainRouteMetadata))]
    public partial class BridgeTypeByMainRoute
    {
    }
    public class BridgeTypeByMainRouteMetadata
    {
        [Key]
        [DisplayName("MainRoute Id")]
