...
namespace ERA_BMS.Areas.Admin.Controllers
{
    ...
    public class BridgeTypesController : Controller
    {
        ...
        // GET: Admin/BridgeTypes/New
        public ActionResult New()
        {
            return View();
        }

        // POST: Admin/BridgeTypes/New
        // To protect from overposting attacks, enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult New([Bind(Include = "BridgeTypeId,BridgeTypeName,BridgeTypeShortCode,Remark")] BridgeType bridgeType)
        {
